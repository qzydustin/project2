...
export function Order(props) {
    ...
    if(order.isEditing){
        return (
            <div className="order">
                <div className="edit-items"><input type="text" value={items} onChange={e =>
                    setItems(e.target.value)
                }/></div>
                <div className="edit-amount"><input type="text" value={amount} onChange={e =>
                    setAmount(e.target.value)
                }/></div>
                <div className="edit-note"><input type="text" value={note} onChange={e =>
                    setNote(e.target.value)
                }/></div>
                <div className="edit-urgent"><input type="text" value={urgent} onChange={e =>
        ...
        return (
            <div className="order">
                <div className="items" onClick = {onSearchItems}>{order.items}</div>
                <div className="amount">{order.amount}</div>
                <div className="note">{order.note}</div>
                <div className="urgent" onClick = {onSearchUrgent}>{order.urgent}</div>
